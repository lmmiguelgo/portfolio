...
export default function Resume() {
  ...
  return (
    <>
      ...
      <section
        id="resume"
        className="relative py-24 px-6 bg-[var(--card)] md:py-0 overflow-hidden"
      >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              <motion.div
                ...
                whileHover={{
                  boxShadow:
                    "0 25px 60px -10px rgba(99,102,241,0.15), 0 0 0 1px rgba(99,102,241,0.12)",
                }}
      ...
      <AnimatePresence>
        {fullscreen && (
          ...
          >
            ...
            {/* Fullscreen PDF */}
            <div className="flex-1 overflow-y-auto overscroll-contain flex flex-col items-center py-8 px-4 gap-4">
              <motion.div
                ...
                className=" rounded-xl overflow-y-scroll shadow-2xl"
              >
                <Document {...docProps}>
                  <Page
                    pageNumber={currentPage}
